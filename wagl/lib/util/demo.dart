...
class _CircleListState extends State<CircleListDemo>
  ...
  Widget build(BuildContext context) {
    ...
    var outerRadius = widget.Size;
    var betweenRadius = widget.betweenRadius;
